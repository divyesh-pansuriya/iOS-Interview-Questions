...
## Table of Contents
- [Database](https://github.com/divyesh-pansuriya/iOS-Interview-Questions#database)
    - What is Core Data?
    - When would you use Core Data over NSUserDefault?
    - What is a managed object context?
    - What is NSFetchRequest?
- [Debugging](https://github.com/divyesh-pansuriya/iOS-Interview-Questions#debugging)
    - What are some ways of debugging in iOS?
- [Design Pattern](https://github.com/divyesh-pansuriya/iOS-Interview-Questions#design-patterns)
    - What is Singleton Pattern?
    - What is the delegation pattern?
    - What is MVC?
    - What is MVVM?
- [General / Uncategorized](https://github.com/divyesh-pansuriya/iOS-Interview-Questions#general--uncategorized)
    ...
    - What is KVO?
- [Memory Management](https://github.com/divyesh-pansuriya/iOS-Interview-Questions#memory-management)
...
- [Networking](https://github.com/divyesh-pansuriya/iOS-Interview-Questions#networking)
- [Objective-C](https://github.com/divyesh-pansuriya/iOS-Interview-Questions#objective-c)
    - What is synthesize in Objective-C?
    - What is dynamic in Objective-C?
    - What is the difference between _name vs self.name?
    - What are blocks in Objective-C?
    - What is the difference between category and extension in Objective-C?
- [Swift](https://github.com/divyesh-pansuriya/iOS-Interview-Questions#swift)
    - What is the difference between public and open? Why is it important to have both?
    - What is the difference between var and let?
    - What is the difference between a struct and a class?
    - What is the difference between implicit and explicit?
- [Thread Management](https://github.com/divyesh-pansuriya/iOS-Interview-Questions#thread-management)
...
- [Unit Testing / UI Testing](https://github.com/divyesh-pansuriya/iOS-Interview-Questions#unit-testing--ui-testing)
    - What is the purpose of unit testing? What are the benefits?
- [View / Storyboard](https://github.com/divyesh-pansuriya/iOS-Interview-Questions#view--storyboard)
    ...
    - What is autolayout?
- [Algorithm Resources](https://github.com/divyesh-pansuriya/iOS-Interview-Questions#algorithm-resources)
    - EKAlgorithm
    - swift-algorithm-club
- [Contributing](https://github.com/divyesh-pansuriya/iOS-Interview-Questions#contributing)
- [Thank You](https://github.com/divyesh-pansuriya/iOS-Interview-Questions#thank-you)
...
```swift
var name: String = "divyesh-pansuriya" // explicit
var name = "divyesh-pansuriya" // implicit
```
</details>
